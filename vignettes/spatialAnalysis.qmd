...
Another approach we can take is to examine the expression of CD8 in the broad spatial domains we identified earlier. We would expect to see CD8 expression to be higher in the tumour domain (`D2`) compared to the non-tumour domain (`D1`). 
